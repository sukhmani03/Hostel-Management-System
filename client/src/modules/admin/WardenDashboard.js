      ...
      <div style={styles.bottomRow}>
        ...
        <div className="card" style={{ flex: 1 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            <QuickLink icon="📋" label="Manage Complaints"  to="/admin/complaints"  color="#1a73e8" />
            <QuickLink icon="🛏️"  label="Update Room Status" to="/admin/rooms"       color="#34a853" />
            <QuickLink icon="🎓" label="View Students"      to="/admin/students"    color="#8b5cf6" />
            <QuickLink icon="✅" label="Attendance"         to="/admin/attendance"  color="#fbbc04" />
          </div>
        </div>
      </div>
