                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      borderColor: isPresent ? '#10b981' : '#ea4335',
                      cursor: 'pointer',
                    }}
                  >
                    <div style={{ ...styles.avatar, background: isPresent ? '#10b981' : '#ea4335' }}>
                    ...
                    <div style={{ ...styles.toggle, background: isPresent ? '#10b981' : '#ea4335' }}>
                      {isPresent ? '✅' : '❌'}
                    </div>
                  </div>
                );
